...
<body>
    ...
    <section class="fistbar">
        <div class="left">
            ...
            <div class="butes">
                <button class="bttes"><a href="logreg/login.php">Log out</a></button>
            </div>
        </div>
...
if($result){
   ...
   <td>'.$medicine.'</td>
   <td >
   <button style="background-color:#2ECC71;border:0px;border-radius:20px;margin-left:10px;height:15px;width:75px;"><a style="color:black;text-decoration:none;" href="calculateprice.php?orderid='.$oid.'">Totle Prices</a></button>
...
if($result){
   ...
   <td>'.$price.'</td>
   <td>
   <button style="background-color:#2ECC71;border:0px;border-radius:20px;margin-left:10px;height:15px;width:75px;"><a style="color:black;text-decoration:none;" href="updatedinuth.php?updateqty='.$id.'">Update</a></button>
   </td>
   </tr>';
}
}
